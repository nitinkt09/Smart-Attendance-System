...
# titl = tk.Label(window, bg="black", relief=RIDGE, bd=10, font=("arial", 25))
# titl.pack(fill=X)
# l1 = tk.Label(window, image=logo1, bg="black",)
# l1.place(x=470, y=10)

# titl = tk.Label(
#     window, text="Attendance Management System", bg="black", fg="green", font=("arial", 20),
# )
# titl.place(x=525, y=12)

a = tk.Label(
    window,
    text="Smart Attendance Management System Using OpenCV",
    bg="white",
    fg="black",
    bd=10,
    font=("arial", 30),
...
def TakeImageUI():
    ...
    titl = tk.Label(ImageUI, bg="white", relief=RIDGE, bd=10, font=("arial", 25))
    titl.pack(fill=X)
    # image and title
    titl = tk.Label(
        ImageUI, text="Register Your Face", bg="white", fg="green", font=("arial", 20),
    )
