...
def subjectchoose(text_to_speech):
    def calculate_attendance():
        ...
        fileName = f"{subject_folder}/{Subject}_{date}_{Hour}-{Minute}-{Second}.csv"
        ...
        if not filenames:
            e = "No CSV files found for this subject."
            text_to_speech(e)
            return
        ...
        # newdf.to_csv(os.path.join(subject_folder,f"{Subject}.csv"), index=False)
        ...
        #cs = os.path.join(subject_folder, f"{Subject}.csv")
        cs = fileName
